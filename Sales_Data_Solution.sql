...
select segment from clean_weekly_sales where segment IS NULL;
...
-- Passing empty tupple because it is auto incremented (1),(2),(3)....(50)-- 
...
-- adding 50 more to the colum "x"-- 
insert into seq100 select x + 50 from seq100;

select * from seq100;

-- creating sequence of 52(as total week number is 52)-- 
create table seq52 as (select x from seq100 limit 52);

-- week number which is present in the table "(seq52)" but not in the table "clean_weekly_sales"
...
--  "cte_monthly_platform_sales" for storing monthly sales
